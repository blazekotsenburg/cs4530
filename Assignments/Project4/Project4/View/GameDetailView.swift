...
class GameDetailView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        stackView.topAnchor.constraint(equalTo: safeAreaLayoutGuide.topAnchor, constant: 12.0).isActive = true
        ...
        stackView.bottomAnchor.constraint(equalTo: safeAreaLayoutGuide.bottomAnchor, constant: -12.0).isActive = true
